...
const S = StyleSheet.create({
    wrap: { paddingHorizontal: isWeb ? 32 : 16, paddingTop: isWeb ? 20 : 16, paddingBottom: 12, backgroundColor: '#FFFFFF', zIndex: 1 },
    titleRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 },
    title: { fontSize: isWeb ? 24 : 20, fontWeight: '800', color: '#0F172A', letterSpacing: -0.5 },
