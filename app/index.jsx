...
export default function Index() {
  ...
  if (Platform.OS === 'web') {
    ...
    return (
      <div style={{
        ...
        <img
          src={logoUri}
          style={{ width: 300, height: 300, objectFit: 'contain', marginTop: 50 }}
        />
        <div style={{ padding: 25, paddingBottom: 50, width: '100%', display: 'flex', justifyContent: 'center' }}>
          <button
  ...
  return (
    ...
    >
      ...
      <View style={{ padding: 25, height: '100%', borderTopLeftRadius: 35, borderTopRightRadius: 35 }}>
...
const styles = StyleSheet.create({
  ...
  buttonText: { fontSize: 30, fontWeight: 'bold', textAlign: 'center', color: Colors.White },
  logo: { marginTop: 50, height: 500, width: '100%', alignItems: 'center', justifyContent: 'center' },
});