...
export default function SignIn() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Vui lòng đăng nhập để truy cập tài khoản doanh nghiệp</Text>

      {/* Email */}
      <View style={styles.formGroup}>
        <Text style={styles.label}>Gmail / Tên đăng nhập</Text>
        <View style={styles.box}>
          <Ionicons name="person-outline" size={15} color={Colors.LightGray} style={styles.inputIcon} />
          <TextInput
            style={styles.input}
      ...
      <View style={styles.formGroup}>
        ...
        <View style={styles.box}>
          ...
          <TouchableOpacity onPress={() => setShowIcon(!showIcon)}>
            <Ionicons name={showIcon ? 'eye-off-outline' : 'eye-outline'} size={20} color={Colors.LightGray} style={styles.eyeIcon} />
          </TouchableOpacity>
        </View>
        <TouchableOpacity style={styles.forgotBtn} onPress={() => router.push('/auth/resetPassword')}>
      ...
      <Text style={styles.signup}>
        ...
        <Text style={styles.link} onPress={() => router.push('/auth/signUp')}>Đăng ký ngay</Text>
      </Text>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  box:             { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: Colors.Border, borderRadius: 8, paddingHorizontal: 8, marginTop: 4 },
  inputIcon:       { margin: 8 },
  ...
  loginButton:     { width: '100%', padding: 14, backgroundColor: Colors.Primary, borderRadius: 8, alignItems: 'center', marginTop: 10 },
  ...
  signup:          { fontSize: 12, color: Colors.TextSecondary },
});