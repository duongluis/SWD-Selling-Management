...
export default function AddService() {
    ...
    // Dùng hook để lấy customers
    const { customers } = useCustomers();

    // Fetch orders từ customers
    useEffect(() => {
    ...
    // Khi chọn đơn hàng → tự điền thông tin
    const handleSelectOrder = (order) => {
        setSelectedOrder(order);
        setCustomerName(order.customer || '');
        // Tìm phone từ _phone field
    ...
    const handleSubmit = async () => {
        ...
        try {
            const newService = {
                id: serviceId,
                type: serviceType,
                // Thông tin thiết bị từ đơn hàng (nếu có)
            ...
            showSuccess('Dịch vụ đã được tạo!', `Mã dịch vụ: ${serviceId}`,
            ...
            <ScrollView style={{ maxHeight: 220 }} showsVerticalScrollIndicator={false}>
                {orderLoading ? (
                    ...
                    <Text style={styles.pickerEmpty}>
                        {orderSearch ? 'Không tìm thấy' : 'Chưa có đơn hàng nào'}
                    </Text>
                    ...
                    return (
                        ...
                        >
                            ...
                            <Text style={styles.pickerItemAmount}>{formatCurrency(total)}</Text>
                        </TouchableOpacity>
                    );
                })}
            </ScrollView>
                    ...
                    <View style={W.grid}>
                        ...
                        <View style={W.col}>
                            ...
                            <View style={W.card}>
                                ...
                                {/* Hiển thị sản phẩm của đơn hàng đã chọn */}
                                    ...
                                    <View style={W.orderItemsBox}>
                                        ...
                                        {selectedOrder.items.map((item, i) => (
                                            <View key={i} style={W.orderItemRow}>
                                                ...
                                                <Text style={W.orderItemPrice}>{formatCurrency(item.price)}</Text>
                                            </View>
                                        ))}
                                    </View>
                                )}
                            ...
                            <View style={W.card}>
                                ...
                                <View style={W.inputGroup}>
                                    ...
                                    <View style={[W.inputBox, { alignItems: 'flex-start', minHeight: 90 }]}>
                                        <TextInput style={[W.input, { textAlignVertical: 'top' }]} placeholder="Yêu cầu cụ thể..." placeholderTextColor="#94A3B8" multiline value={note} onChangeText={setNote} />
                                    </View>
                                </View>
                            </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={M.scroll}>
                    ...
                    <View style={M.card}>
                        ...
                        <View style={[M.inputBox, { alignItems: 'flex-start', minHeight: 100 }]}>
                            <TextInput style={[M.input, { textAlignVertical: 'top', paddingTop: 2 }]} placeholder="Yêu cầu cụ thể..." placeholderTextColor="#94A3B8" multiline value={note} onChangeText={setNote} />
                        </View>
                    </View>
...
const M = StyleSheet.create({
    ...
    banner: { backgroundColor: '#0F172A', margin: 16, borderRadius: 18, height: 160, alignItems: 'center', justifyContent: 'center', gap: 12, overflow: 'hidden' },
    bannerIcon: { width: 72, height: 72, borderRadius: 36, alignItems: 'center', justifyContent: 'center' },
    bannerText: { fontSize: 14, color: 'rgba(255,255,255,0.7)', fontWeight: '500' },
